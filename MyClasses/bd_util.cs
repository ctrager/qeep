    ...
    */
    ...
    public static class bd_util
    {
        ...
        public static bool check_user_permissions(HttpContext context)
        {
            ...
            if (context.Request.Cookies.ContainsKey(bd_util.keep_SESSION_ID))
            {
                session_id = context.Request.Cookies[bd_util.keep_SESSION_ID];
                context.Session.SetString(bd_util.keep_SESSION_ID, session_id);
            }
